      ...
      <header className='text-gray-700 body-font border-b border-gray-200'>
        <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
          ...
          <nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
            ...
            <a className='mr-5 hover:text-gray-900'>Find Influencers</a>
          </nav>
        </div>
      </header>
        ...
        <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
          <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
            <h1 className='title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900'>
              Partner with Lens influencers big and small to support your brand
            </h1>
            <p className='mb-8 text-2xl leading-relaxed'>
              Whether you are a DAO, clothing company, or community organization, sponsorship
              marketing can be a powerful tool to spread your message around the world.
            </p>
          ...
          <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6'>
            <img
              ...
              alt='hero'
              src='images/influencer-3.webp'></img>
          </div>
        </div>
      </section>
        ...
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-col text-center w-full mb-20'>
            <h2 className='text-xs text-green-500 tracking-widest font-medium title-font mb-1'>
              INFLULENSERS ARE HARD AT WORK
            </h2>
            <h1 className='sm:text-3xl text-2xl font-medium title-font text-gray-900'>
              Influencer marketing, tailored for your organization
            </h1>
          </div>
            ...
            <div className='flex flex-col mb-10 lg:items-start items-center'>
              <div className='flex-grow'>
                <h2 className='text-gray-900 text-2xl title-font font-medium mb-3'>
                  🌿 Lens Protocol Native Posts 🌿
                </h2>
                <p className='leading-relaxed text-base'>
                  Right after being hired for a sponsorship gig, InfluLENSers can immediatley post
                  on Lens - all from their influencer dashboard.
                </p>
                <a className='mt-3 text-green-500 inline-flex items-center'>Learn About Lens</a>
              </div>
            </div>
            <div className='flex flex-col mb-10 lg:items-start items-center'>
              <div className='flex-grow'>
                <h2 className='text-gray-900 text-2xl title-font font-medium mb-3'>
                  🍀 Hiring Powered by TalentLayer 🦝
                </h2>
                <p className='leading-relaxed text-base'>
                  Have peace of mind with on-chain escrow and job reviews. Your influencer marketing
                  posts are broadcast to TalentLayer's network of interoperable hiring platforms.
                </p>
                <a className='mt-3 text-green-500 inline-flex items-center'>
          ...
          <div className='flex flex-wrap -m-4'>
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border p-6 rounded-lg'>
                <img
                  alt='team'
                  className=' object-cover object-center flex-shrink-0 mr-4'
                  src='images/polygon.png'></img>
              </div>
            </div>
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border p-6 rounded-lg'>
            ...
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border  p-6 rounded-lg'>
                <img
                  alt='team'
                  className=' object-cover object-center flex-shrink-0 mr-4'
                  src='images/talentlayer.png'></img>
              </div>
            </div>
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border p-6 rounded-lg'>
            ...
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border p-6 rounded-lg'>
                <img
                  alt='team'
                  className=' object-cover object-center flex-shrink-0 mr-4'
                  src='images/nouns.png'></img>
              </div>
            </div>
            {/* <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/mantle.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/optimism.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/gnosis.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/linea.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" w-20 object-cover object-center flex-shrink-0 mr-4" src="images/fevm.svg"></img>
        </div>
      </div> */}
          </div>
        </div>
        ...
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-col text-center w-full mb-20'>
            ...
            <p className='lg:w-2/3 mx-auto leading-relaxed text-base'>
              We're a scrappy crew of Lens lovers who are passionate about helping creators monetize
              on Lens.
            </p>
          </div>
            ...
            <div className='p-2 lg:w-1/3 md:w-1/2 w-full'>
              <div className='h-full flex items-center border-gray-200 border p-4 rounded-lg'>
                <img
                  alt='team'
                  className='w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4'
                  src='images/default-avatar-1.jpeg'></img>
                <div className='flex-grow'>
            ...
            <div className='p-2 lg:w-1/3 md:w-1/2 w-full'>
              <div className='h-full flex items-center border-gray-200 border p-4 rounded-lg'>
                <img
                  alt='team'
                  className='w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4'
                  src='images/default-avatar-10.jpeg'></img>
                <div className='flex-grow'>
          ...
          <div className='flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center'>
            <div className='flex flex-col mb-10 lg:items-start items-center'>
              <div className='flex-grow'>
                ...
                <p className='leading-relaxed text-base'>
                  Our code is fully open-source and we'd love your feedback! Find us on Github.
                </p>
