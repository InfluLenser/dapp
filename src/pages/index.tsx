  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        ...
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/polygon.png"></img>
          
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/lens.png"></img>
          
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border  p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/talentlayer.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
          
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/graph.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/safe.png"></img>
        </div>
      </div>
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
        <img alt="team" className=" object-cover object-center flex-shrink-0 mr-4" src="images/nouns.png"></img>
        </div>
      </div>
      {/* <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border p-6 rounded-lg">
