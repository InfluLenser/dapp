    ...
    <div className='flex flex-row justify-between items-center ml-4 sm:ml-2'>
      {isSubmitting ? (
        ...
        <button
          ...
          type='button'
          className='px-5 py-2 border border-il-green-300 rounded-md text-il-green-500 bg-il-green-800 hover:border-il-green-800 hover:text-il-green-800 hover:bg-il-lightgreen-200 duration-150'>
          {'Connect first'}
        </button>
      )}
    </div>
